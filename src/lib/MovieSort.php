...
class MovieSort
{
    function renderHtml( $can_vote )
    {
        ...
        echo "<span class=\"sort_link\"><a href='{$sort_by_likes}'>Likes</a></span><br/>";
        $sort_by_hates = 'javascript:sortMovies( "sort_by_hates", '.$can_vote.' )';
        echo "<span class=\"sort_link\"><a href='{$sort_by_hates}'>Hates</a></span><br/>";
        $sort_by_dates = 'javascript:sortMovies( "sort_by_dates", '.$can_vote.' )';
        echo "<span class=\"sort_link\"><a href='{$sort_by_dates}'>Dates</a></span><br/>";
        echo "</div>";
    }
}
